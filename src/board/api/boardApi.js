...
export const getBoardList = () => board.get('/boardlist').then((res) => res.data.data);
export const getBoardDetail = (id) => board.get(`/${id}`).then((res) => res.data.data);
export const createBoard = (payload) => board.post('/saveBoard', payload).then((res) => res.data.data);
